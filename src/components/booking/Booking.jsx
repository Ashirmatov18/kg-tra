...
export default function Booking() {
  ...
  const api = `http://api.encar.com/search/car/list/premium?count=true&q=(And.Hidden.N.${search}_.CarType.Y.)&sr=%7CModifiedDate%7C${currentPage}%7C10`;
  ...
  'http://api.encar.com/search/car/list/premium?count=true&q=(And.Hidden.N.${search}_.CarType.Y.)&sr=%7CModifiedDate%7C${currentPage}%7C10'
  // const getCar = async () => {
